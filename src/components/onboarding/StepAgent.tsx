  ...
  return (
    ...
    >
      <motion.div variants={itemVariants} className="text-center mb-8">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">Configurar Agente</h3>
      ...
      <div className="space-y-6 max-w-lg mx-auto">
        ...
        <motion.div variants={itemVariants} className="space-y-2">
          <div className="flex items-center justify-between">
            <Label htmlFor="systemPrompt" className="text-slate-300 flex items-center gap-2">
          ...
          <Textarea
            ...
            className="bg-slate-800/50 border-slate-700 focus:border-violet-500 text-white placeholder:text-slate-500 min-h-[200px] resize-none"
          />
