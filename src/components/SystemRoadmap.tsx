...
import { ChevronDown, ChevronRight, Layout, Monitor, Server, Database, GitBranch, Palette, Key, FileCode, MessageSquare, Calendar, Users, BarChart3, Settings, Zap, Layers } from 'lucide-react';
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-800">
                ...
                <tr>
                  <td className="p-4 font-mono text-slate-400">/kanban</td>
                  <td className="p-4 text-white">Kanban.tsx</td>
                  <td className="p-4 text-slate-400">Pipeline de vendas/CRM com drag-and-drop de deals</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="p-4 font-mono text-slate-400">/functions</td>
                  <td className="p-4 text-white">Functions.tsx</td>
                  <td className="p-4 text-slate-400">Documentação e blueprints de backend (esta página)</td>
                </tr>
                <tr>
                  <td className="p-4 font-mono text-slate-400">/settings</td>
                  <td className="p-4 text-white">Settings.tsx</td>
                  <td className="p-4 text-slate-400">Configurações do agente IA e integrações de APIs</td>
                </tr>
                <tr>
...
// 4. Realtime detecta INSERT → deduplicação ignora (ID real já existe)`}
              ...
              <div className="bg-slate-950 border border-slate-700 rounded-lg p-4">
                ...
                <div className="bg-slate-900 rounded p-3">
                  ...
                  <ul className="text-xs text-slate-400 space-y-1">
                    <li>• <code className="text-emerald-400">companyName</code> - Nome da empresa (fallback: "Viver de IA")</li>
                    <li>• <code className="text-emerald-400">sdrName</code> - Nome do agente IA (fallback: "Nina")</li>
                ...
                <div className="bg-slate-950 border border-slate-700 rounded-lg p-4">
                  <ul className="text-sm text-slate-300 space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-violet-400">•</span>
                      <div>
                        <span className="font-bold">Cal.com (opcional):</span>{' '}
                        <span className="text-slate-400">API Key para agendamentos automáticos</span>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div>
                ...
                <div className="bg-slate-950 border border-slate-700 rounded-lg p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-xs font-bold text-pink-400 mb-2">Cal.com (opcional - agendamentos)</p>
                      <ul className="text-sm text-slate-300 space-y-1 font-mono pl-4">
                        <li className="text-xs"><code>calcom_api_key</code></li>
                      </ul>
                    </div>

                    <div>
                      <p className="text-xs font-bold text-blue-400 mb-2">OpenAI (não mais necessário)</p>
                      <ul className="text-sm text-slate-400 space-y-1 pl-4">
                        <li className="text-xs">⚠️ O sistema usa <strong>Lovable AI Gateway</strong>, eliminando necessidade de API key própria</li>
                        <li className="text-xs">Campos <code>openai_api_key</code>, <code>openai_model</code>, <code>openai_assistant_id</code> são legacy</li>
                      </ul>
                    </div>
                  </div>
                </div>
