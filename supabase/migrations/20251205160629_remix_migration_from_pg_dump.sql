...
CREATE POLICY "Allow all operations on appointments" ON public.appointments USING (true) WITH CHECK (true);


--
-- Name: contacts Allow all operations on contacts; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on contacts" ON public.contacts USING (true) WITH CHECK (true);


--
-- Name: conversation_states Allow all operations on conversation_states; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on conversation_states" ON public.conversation_states USING (true) WITH CHECK (true);


--
-- Name: conversations Allow all operations on conversations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: deal_activities Allow all operations on deal_activities; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on deal_activities" ON public.deal_activities USING (true) WITH CHECK (true);


--
-- Name: deals Allow all operations on deals; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on deals" ON public.deals USING (true) WITH CHECK (true);
...
--
-- Name: messages Allow all operations on messages; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nina_settings Allow all operations on nina_settings; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on nina_settings" ON public.nina_settings USING (true) WITH CHECK (true);


--
-- Name: pipeline_stages Allow all operations on pipeline_stages; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on pipeline_stages" ON public.pipeline_stages USING (true) WITH CHECK (true);
...
--
-- Name: tag_definitions Allow all operations on tag_definitions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on tag_definitions" ON public.tag_definitions USING (true) WITH CHECK (true);


--
-- Name: team_functions Allow all operations on team_functions; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on team_functions" ON public.team_functions USING (true) WITH CHECK (true);


--
-- Name: team_members Allow all operations on team_members; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on team_members" ON public.team_members USING (true) WITH CHECK (true);


--
-- Name: teams Allow all operations on teams; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all operations on teams" ON public.teams USING (true) WITH CHECK (true);
